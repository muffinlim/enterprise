...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2024 at 11:59 AM
...
(1, 3, 1, '2024-04-20 16:53:15', 'test', 'Screenshot 2021-05-11 005046.png'),
(2, 3, 1, '2024-04-20 16:54:05', 'Guys , this SQL code is amazing', 'Screenshot 2023-04-14 151405.png');
...
INSERT INTO `comment` (`Comment_Id`, `Student_Id`, `Blog_Id`, `Comment_Detail`) VALUES
(4, 3, 2, 'teach me some sql'),
(5, 3, 1, 'This shirt is nice for the new IT club'),
(6, 2, 1, 'Yes this design concept is nice.'),
(7, 2, 2, 'Sure , DM my whatsapp');
